	...
	$scope.listings = [
		{
			...
			image: 'https://c1.staticflickr.com/4/3431/3892949064_f627556b0e_b.jpg',
		...
		},
		{
			...
			image: 'http://www.aljazeera.com/mritems/Images/2015/6/29/5e973f2402864e32991a8b8998e695c0_18.jpg',
		...
		},
		{
			...
			image: 'http://kingofwallpapers.com/african/african-003.jpg',
...
.controller("Donated", function($scope, $rootScope) {
	$scope.listing = $rootScope.listing;
	console.log($rootScope.listing);
});
